...
# ---------------------------------------------------------------------------- #
_C.VIEWPOINT = False
_C.VIEWPOINT_RESIDUAL = False
_C.VP_BINS = 16
_C.VP_WEIGHT_LOSS = 1. # 1 to do nothing
# Freeze all model except VP
_C.FREEZE_ALL = False

# ---------------------------------------------------------------------------- #
# 3D encoding options
# ---------------------------------------------------------------------------- #
_C.ROTATED_BOX_TRAINING = False

# ---------------------------------------------------------------------------- #
# 3D height training options
# ---------------------------------------------------------------------------- #
_C.HEIGHT_TRAINING = False
_C.WEIGHTS_HEIGHT = (5.0, 0.5, 10.0)
